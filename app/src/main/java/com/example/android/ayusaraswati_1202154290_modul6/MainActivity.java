...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        username = (EditText) findViewById(R.id.username);//untuk akses data dari edit text email
        password = (EditText) findViewById(R.id.password);//untuk akses data dari edit text password
